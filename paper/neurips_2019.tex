...
\begin{table}[h]
	...
	\begin{tabular}{lcccc}
		...
		\midrule
		ConvNet & 99.4\% & 92.8\% & 92.6\% & 88.2\% \\
		CapsNet           & 99.4\% & 92.6\% & 92.4\% & 88.2\% \\
		\bottomrule\\
	\end{tabular}
...
\begin{table}[h]
	...
	\begin{tabular}{llcccc}
		...
		\midrule
		\multirow{2}{*}{CW} & ConvNet & 0.8\% & 1.6\% & 2.7\% &  \\
		& CapsNet            & 1.8\% & 2.1\% & 3.8\% &  \\
		\midrule
...
\begin{table}[h]
	...
	\begin{tabular}{llcccc}
		...
		Attack & Network       & MNIST & Fashion-MNIST & SVHN & CIFAR10  \\
		\midrule
		\multirow{2}{*}{CW} & ConvNet & 1.4 & 0.51 & 0.67 & 0.38 \\
