...
\usepackage[style=authoryear,natbib=true,backend=bibtex,mincitenames=1,maxcitenames=2,maxbibnames=99,uniquelist=false,dashed=false]{biblatex}

% My stuff
\usepackage{custom_ba} % Extra packages, macros etc.
% End my stuff
