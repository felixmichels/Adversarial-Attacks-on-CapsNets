...
\begin{itemize}
	...
	\item (Primary) Conv Caps, dim=$d$: A convolutional ()primary) capsule layer with capsules of dimension $d$ as explained in Section~\ref{sec:capsules}. Takes same further arguments as an ordinary convolutional layer.
	\item Dense Caps, dim=$d$: A dense capsule layer with capsules of dimension $d$ as explained in Section~\ref{sec:capsules}.
\end{itemize}
