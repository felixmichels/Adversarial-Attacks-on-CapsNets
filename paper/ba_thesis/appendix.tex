...
\lstinputlisting[firstline=3]{../../code/attacks/cw.py}
\vspace{1cm}
\lstinputlisting[firstline=3]{../../code/attacks/boundary_attack.py}
\vspace{1cm}
\lstinputlisting[firstline=3]{../../code/attacks/deepfool.py}
\vspace{1cm}
\lstinputlisting[firstline=3]{../../code/attacks/universal_perturbation.py}