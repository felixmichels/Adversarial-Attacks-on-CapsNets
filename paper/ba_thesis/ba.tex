...
\newcommand{\bearbeiter}{Felix Michels}

% Geben Sie hier den Titel Ihrer Arbeit an:
\newcommand{\titel}{Adversarial Attacks on Capsule Networks}

% Geben Sie das Datum des Beginns und Ende der Bachelorarbeit ein:
\newcommand{\beginndatum}{08. April 2019}
\newcommand{\abgabedatum}{21. Juli 2019}
...
\clearpage % list of figures/tables needs a whole page anyway
