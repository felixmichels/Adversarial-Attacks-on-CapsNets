...
\begin{wrapfigure}{R}{7.1cm}
	...
	\caption[t-SNE plot with additional ConvNet]{t-SNE plot of universal perturbations for CIFAR-10 with additional ConvNet architecture. The two clusters of the ConvNets in the top left are close compared to the cluster of the CapsNet.}
	\label{fig:tsnealt}
\end{wrapfigure}
