...
In \Cref{tab:images} some examples of the product of the attacks on CIFAR-10 can be seen.
...
(i.e.\ the size of the perturbation in some metric. In our case this is the euclidean norm, see \Cref{sec:attacks} \todo{check if ref is correct after I write introduction}).
...
In \Cref{fig:tsne} can furthermore subclusters based on the data set splits used to calculate the perturbations be seen.
