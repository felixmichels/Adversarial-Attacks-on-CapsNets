...
(i.e.\ the distance to the original image in some metric. In our case this is the euclidean norm, see \Cref{sec:attacks}).
...
Whilst the curve of the CapsNet decreases more slowly than that of the ConvNet in the case of the CIFAR-10 dataset, the opposite occurs for the other cases. \todo{talk about linearity hypothesis}
